...
def main():
    ...
    with open("COURT_TYPE.csv", "w", newline="", encoding="utf-8") as f:
        ...
        type_data = [
            ...
            ("CTP02", "Sân bóng đá 7 người"),
            ("CTP03", "Sân cầu lông đơn"),
            ("CTP04", "Sân cầu lông đôi"),
            ("CTP05", "Sân tennis"),
            ("CTP06", "Sân bóng rổ"),
            ("CTP07", "Sân bóng chuyền"),
            ("CTP08", "Sân pickleball"),
        ]
        for ct_id, name in type_data[:N_COURT_TYPE]:
            court_types.append(ct_id)
            court_type_data[ct_id] = name
    ...
    with open("SPORT_COURT.csv", "w", newline="", encoding="utf-8") as f:
        ...
        # Giá sân theo loại (VNĐ/giờ)
        COURT_PRICES = {
            "CTP01": (200_000, 400_000),  # Sân bóng đá 5
            "CTP02": (300_000, 600_000),  # Sân bóng đá 7
            "CTP03": (60_000, 120_000),  # Cầu lông đơn
            "CTP04": (80_000, 150_000),  # Cầu lông đôi
            "CTP05": (150_000, 350_000),  # Tennis
            "CTP06": (200_000, 400_000),  # Bóng rổ
            "CTP07": (150_000, 300_000),  # Bóng chuyền
            "CTP08": (100_000, 200_000),  # Pickleball
        }
        ...
        for i in range(1, N_SPORT_COURT + 1):
            ...
            price_min, price_max = COURT_PRICES.get(ctype, (100_000, 300_000))
            price = random.randint(price_min, price_max)
    ...
    with open("BOOKING_FORM.csv", "w", newline="", encoding="utf-8") as f:
        ...
        for i in range(1, N_BOOKING + 1):
            ...
            ctype_name = random.choice(court_type_names[:N_COURT_TYPE])
