...
BEGIN
    ...
    ALTER TABLE dbo.ACCOUNT_LOGIN NOCHECK CONSTRAINT ALL;
    ALTER TABLE dbo.COACH NOCHECK CONSTRAINT ALL;
    ALTER TABLE dbo.SERVICE NOCHECK CONSTRAINT ALL;
    ALTER TABLE dbo.COURT_TYPE NOCHECK CONSTRAINT ALL;

    PRINT 'Disabling foreign key constraints...';
    
    BEGIN TRY
        -- Delete all data (reverse order of foreign keys)
        -- CUSTOMER references ACCOUNT_LOGIN, so delete CUSTOMER first
        ...
        ALTER TABLE dbo.ACCOUNT_LOGIN CHECK CONSTRAINT ALL;
        ALTER TABLE dbo.COACH CHECK CONSTRAINT ALL;
        ALTER TABLE dbo.SERVICE CHECK CONSTRAINT ALL;
        ALTER TABLE dbo.COURT_TYPE CHECK CONSTRAINT ALL;
